...
const songlist: (Single | Album)[] = [
    ...
    },
    {
        ...
        Tracks: [
            ...
            },
            {
                ...
                Title: "TERE HO KE",
                Artist: "King, Bella",
                url: `${server[3]}/hls/listen/Tere Ho Ke - King/output.m3u8`,
                Duration: "3: 43"
            }
        ]
    },
    ...
    },
    {
        ...
        Artist: "Anuv Jain",
        Duration: "4: 11",
        url: `${server[3]}/hls/listen/Jo Tum Mere Ho - Anuv Jain/output.m3u8`,
        lyrics: true,
        sync: true
    },
    {
    ...
    },
    {
        ...
        Duration: "4: 18",
        url: `${server[3]}/hls/listen/Mayavi - Sanjith Hegde/output.m3u8`
    },
    {
        ...
        Artist: "Badshah",
        Duration: "2: 52",
        url: `${server[3]}/hls/listen/Morni - Badshah/output.m3u8`
    },
    {
        ...
        Tracks: [
            {
                ...
                Title: "Peaches",
                Artist: "Diljit Dosanjh",
                url: `${server[3]}/hls/listen/Peaches - Diljit Dosanjh/output.m3u8`,
                Duration: "3: 09"
            },
            {
                ...
                Title: "Lemonade",
                Artist: "Diljit Dosanjh",
                url: `${server[3]}/hls/listen/Lemonade - Diljit Dosanjh/output.m3u8`,
                Duration: "2: 46"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                Artist: "Coldplay",
                url: `${server[3]}/hls/listen/A Sky Full Of Stars - Coldplay/output.m3u8`,
                Duration: "4: 27"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                url: `${server[3]}/hls/listen/Zamaana Lage - Metro In Dino/output.m3u8`,
                Duration: "3: 16"
            },
            {
                ...
                url: `${server[3]}/hls/listen/Dil Ka Kya - Metro In Dino/output.m3u8`,
                Duration: "6: 00",
                lyrics: true,
                sync: true
            },
            {
                ...
                Artist: "Arijit Singh",
                url: `${server[3]}/hls/listen/Aur Mohabbat Kitni Karoon - Metro In Dino/output.m3u8`,
                Duration: "3: 56",
                lyrics: true,
                sync: true
            }
        ...
        Tracks: [
            {
                ...
                Title: "Qayde Se",
                Artist: "Arijit Singh",
                url: `${server[3]}/hls/listen/Qayde Se - Metro In Dino/output.m3u8`,
                Duration: "3: 35",
                lyrics: true,
                sync: true
            }
