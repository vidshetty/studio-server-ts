...
const songlist: (Single|Album)[] = [
    {
        ...
        lyrics: true,
        sync: true,
        url: `${server[1]}/listen/Lose Yourself - Eminem`
    },
    {
        ...
        Duration: "2: 56",
        url: `${server[1]}/listen/Lean On - Major Lazer`
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 51",
                url: `${server[1]}/listen/Starboy - The Weeknd`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Eminem",
                Duration: "4: 58",
                url: `${server[1]}/listen/Cleanin' Out My Closet - Eminem`
            },
            {
                ...
                Artist: "Eminem",
                Duration: "4: 50",
                url: `${server[1]}/listen/Without Me - Eminem`
            },
            {
                ...
                Artist: "Eminem",
                Duration: "5: 50",
                url: `${server[1]}/listen/Superman - Eminem`
            },
            {
                ...
                Duration: "4: 57",
                url: `${server[1]}/listen/'Till I Collapse - Eminem`
            }
        ]
    },
    {
        ...
        Artist: "Tones And I",
        Duration: "3: 29",
        url: `${server[1]}/listen/Dance Monkey - Tones And I`
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Travis Scott",
                Duration: "4: 30",
                url: `${server[0]}/listen/Stargazing - Travis Scott`
            },
            {
                ...
                Artist: "Travis Scott",
                Duration: "5: 12",
                url: `${server[0]}/listen/Sicko Mode - Travis Scott`
            },
            {
                ...
                Artist: "Travis Scott",
                Duration: "3: 10",
                url: `${server[0]}/listen/Butterfly Effect - Travis Scott`
            },
        ]
    },
    {
        ...
        Artist: "Travis Scott",
        Duration: "2: 57",
        url: `${server[0]}/listen/Highest In The Room - Travis Scott`
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Travis Scott",
                Duration: "4: 03",
                url: `${server[0]}/listen/Goosebumps - Travis Scott`
            }
        ]
    },
    {
        ...
        url: `${server[0]}/listen/Aaraam - Brodha V`,
        Duration: "2: 40",
        Artist: "Brodha V",
        Type: "Single",
        releaseDate: date("18-02-2021")
    },
    {
        ...
        url: `${server[0]}/listen/Flex - Brodha V`,
        Duration: "2: 50",
        Artist: "Brodha V",
        Type: "Single",
        releaseDate: date("08-12-2020")
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "1: 48",
                url: `${server[0]}/listen/Asli Hip Hop - Gully Boy`
            },
            {
                ...
                Duration: "3: 05",
                url: `${server[0]}/listen/Mere Gully Mein - Gully Boy`
            },
            {
                ...
                Duration: "1: 05",
                url: `${server[0]}/listen/Doori Poem - Gully Boy`
            },
            {
                ...
                Artist: "Ranveer Singh, Rishi Rich",
                Duration: "2: 15",
                url: `${server[0]}/listen/Doori - Gully Boy`
            },
            {
                ...
                Duration: "2: 14",
                url: `${server[0]}/listen/Sher Aaya Sher - Gully Boy`
            },
            {
                ...
                Duration: "2: 35",
                url: `${server[0]}/listen/Azadi - Gully Boy`
            },
            {
                ...
                Duration: "3: 33",
                url: `${server[0]}/listen/Kab Se Kab Tak - Gully Boy`
            },
            {
                ...
                Duration: "2: 18",
                url: `${server[0]}/listen/Kaam Bhaari - Gully Boy`
            },
            {
                ...
                Duration: "2: 20",
                url: `${server[0]}/listen/Apna Time Aayega - Gully Boy`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                lyrics: true,
                sync: true,
                url: `${server[0]}/listen/The Ringer - Kamikaze`
            },
            // {
            ...
            // },
            {
                ...
                lyrics: true,
                sync: true,
                url: `${server[0]}/listen/Lucky You - Kamikaze`
            },
            // {
            ...
            // },
            {
                ...
                Duration: "4: 48",
                url: `${server[0]}/listen/Not Alike - Kamikaze`
            },
            {
                ...
                Artist: "Eminem",
                Duration: "3: 36",
                url: `${server[0]}/listen/Kamikaze - Kamikaze`
            },
            {
                ...
                lyrics: true,
                sync: true,
                url: `${server[0]}/listen/Fall - Kamikaze`
            },
            // {
            ...
            // },
            {
                ...
                Artist: "Eminem",
                Duration: "4: 29",
                url: `${server[0]}/listen/Venom - Kamikaze`
            }
        ]
    },
    {
        ...
        url: `${server[0]}/listen/Kiston - Roohi`,
        Duration: "2: 41",
        Artist: "Sachin-Jigar, Jubin Nautiyal",
        Type: "Single",
        releaseDate: date("26-02-2021")
    },
    {
        ...
        url: `${server[0]}/listen/1-800-273-8255 - Logic`,
        Duration: "4: 10",
        Artist: "Logic, Alessia Cara, Khalid",
        Type: "Single",
        releaseDate: date("05-05-2017")
    },
    {
        ...
        url: `${server[0]}/listen/Everyday - Logic`,
        Duration: "3: 24",
        Artist: "Logic, Marshmello",
        Type: "Single",
        releaseDate: date("02-03-2018")
    },
    {
        ...
        url: `${server[0]}/listen/Alone - Marshmello`,
        Duration: "4: 33",
        Artist: "Marshmello",
        Type: "Single",
        releaseDate: date("13-05-2016")
    },
    {
        ...
        lyrics: true,
        sync: true,
        url: `${server[0]}/listen/Mockingbird - Eminem`
    },
    {
    ...
    },
    {
        ...
        url: `${server[1]}/listen/Godzilla - Eminem`,
        Duration: "3: 30",
        Artist: "Eminem, Juice WRLD",
        Type: "Single",
        releaseDate: date("17-01-2020")
    },
    {
        ...
        url: `${server[1]}/listen/Killshot - Eminem`,
        Duration: "4: 13",
        Artist: "Eminem",
        Type: "Single",
        lyrics: true,
        ...
        Tracks: [
            {
                ...
                Duration: "3: 50",
                url: `${server[0]}/listen/Raataan Lambiyan - Shershaah`
            },
            {
                ...
                Duration: "3: 48",
                url: `${server[2]}/listen/Ranjha - Shershaah`
            },
            {
                ...
                Duration: "3: 50",
                lyrics: true,
                url: `${server[2]}/listen/Kabhii Tumhhe - Shershaah`
            },
            {
                ...
                Artist: "B Praak",
                Duration: "4: 26",
                url: `${server[1]}/listen/Mann Bharryaa 2.0 - Shershaah`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 52",
                url: `${server[1]}/listen/Payphone - Maroon 5`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Maroon 5",
                Duration: "3: 09",
                url: `${server[1]}/listen/Memories - Maroon 5`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 55",
                url: `${server[1]}/listen/Girls Like You - Maroon 5`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                url: `${server[1]}/listen/Sathi - Ritviz`,
                Duration: "3: 36",
                lyrics: true,
                sync: true
            },
            {
                ...
                Title: "Ari Ari",
                Artist: "Ritviz, Nucleya",
                url: `${server[1]}/listen/Ari Ari - Ritviz`,
                Duration: "2: 47"
            },
            {
                ...
                Title: "Roz",
                Artist: "Ritviz, Nucleya",
                url: `${server[2]}/listen/Roz - Ritviz`,
                Duration: "3: 39",
                lyrics: true,
                sync: true
            },
            {
                ...
                Title: "Baaraat",
                Artist: "Ritviz, Nucleya",
                url: `${server[2]}/listen/Baaraat - Ritviz`,
                Duration: "3: 42"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                url: `${server[2]}/listen/Ambarsariya - Fukrey`,
                Duration: "4: 08"
            }
        ]
    },
    {
        ...
        url: `${server[2]}/listen/Sakhiyaan - Maninder Buttar`,
        Duration: "2: 59",
        Artist: "Maninder Buttar",
        Type: "Single",
        releaseDate: date("21-10-2018")
    },
    {
        ...
        url: `${server[2]}/listen/Thoda Thoda Pyaar - Stebin Ben`,
        Duration: "4: 04",
        Artist: "Stebin Ben",
        Type: "Single",
        releaseDate: date("12-02-2021")
    },
    {
        ...
        url: `${server[2]}/listen/Dil Galti Kar Baitha Hai - Jubin Nautiyal`,
        Duration: "4: 33",
        Artist: "Jubin Nautiyal, Meet Bros.",
        Type: "Single",
        releaseDate: date("25-09-2021")
    },
    {
        ...
        url: `${server[2]}/listen/Khushi Jab Bhi Teri - Jubin Nautiyal`,
        Duration: "4: 00",
        Artist: "Rochak Kohli, Jubin Nautiyal",
        Type: "Single",
        releaseDate: date("23-08-2021")
    },
    {
        ...
        Tracks: [
            {
                ...
                url: `${server[3]}/listen/Daakko Daakko Meka - Pushpa`,
                Duration: "5: 00"
            },
            {
                ...
                url: `${server[3]}/listen/Srivalli - Pushpa`,
                Duration: "3: 44"
            },
            {
                ...
                url: `${server[3]}/listen/Oo Antava Oo Oo Antava - Pushpa`,
                Duration: "3: 47"
            },
            {
                ...
                url: `${server[3]}/listen/Saami Saami - Pushpa`,
                Duration: "3: 49"
            },
        ]
    },
        ...
        Tracks: [
            {
                ...
                url: `${server[1]}/listen/Ik Vaari Aa - Raabta`,
                Duration: "4: 34"
            },
            {
                ...
                url: `${server[1]}/listen/Lambiyaan Si Judaiyaan - Raabta`,
                Duration: "3: 58"
            },
            {
                ...
                url: `${server[1]}/listen/Main Tera Boyfriend - Raabta`,
                Duration: "4: 36"
            },
            {
                ...
                url: `${server[1]}/listen/Darasal - Raabta`,
                Duration: "4: 34"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                url: `${server[0]}/listen/Chammak Challo - RaOne`,
                Duration: "3: 47"
            },
            {
                ...
                url: `${server[0]}/listen/Dildaara - RaOne`,
                Duration: "4: 09"
            },
            {
                ...
                url: `${server[0]}/listen/Criminal - RaOne`,
                Duration: "5: 07"
            }
        ]
    },
    {
        ...
        url: `${server[0]}/listen/Aage Chal - Raftaar`,
        Duration: "3: 49",
        Artist: "Raftaar",
        Type: "Single",
        releaseDate: date("07-01-2021")
    },
    {
        ...
        url: `${server[0]}/listen/OG - KR$NA`,
        Duration: "3: 31",
        Artist: "KR$NA",
        Type: "Single",
        releaseDate: date("13-10-2021")
    },
    {
        ...
        url: `${server[0]}/listen/Sheikh Chilli - Raftaar`,
        Duration: "4: 12",
        Artist: "Raftaar",
        Type: "Single",
        releaseDate: date("08-01-2021")
    },
    {
        ...
        Tracks: [
            {
                ...
                url: `${server[1]}/listen/Aila Re Aillaa - Sooryavanshi`,
                Duration: "2: 36"
            },
            {
                ...
                url: `${server[0]}/listen/Mere Yaaraa - Sooryavanshi`,
                Duration: "4: 45"
            },
            {
                ...
                url: `${server[0]}/listen/Najaa - Sooryavanshi`,
                Duration: "3: 11"
            },
            {
                ...
                url: `${server[3]}/listen/Tip Tip - Sooryavanshi`,
                Duration: "4: 10"
            },
            {
                ...
                Artist: "Lijo George",
                url: `${server[3]}/listen/Sooryavanshi Theme`,
                Duration: "1: 48"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                url: `${server[3]}/listen/Meri Zindagi Hai Tu - Satyameva Jayate 2`,
                Duration: "4: 44"
            },
            {
                ...
                url: `${server[3]}/listen/Kusu Kusu - Satyameva Jayate 2`,
                Duration: "3: 15"
            }
        ]
    },
    {
        ...
        url: `${server[3]}/listen/No Cap - KR$NA`,
        Duration: "3: 25",
        Artist: "KR$NA",
        Type: "Single",
        lyrics: true,
        ...
        Tracks: [
            {
                ...
                Title: "Tu Jaane Na",
                Artist: "Atif Aslam",
                url: `${server[3]}/listen/Tu Jaane Na - Ajab Prem Ki Ghazab Kahani`,
                Duration: "5: 41",
                lyrics: true,
                sync: true
            }
    ...
    },
    {
        ...
        url: `${server[3]}/listen/Boom Boom - Yo Yo Honey Singh`,
        Duration: "3: 30",
        Artist: "Yo Yo Honey Singh, Hommie Dilliwala",
        Type: "Single",
        releaseDate: date("24-11-2021")
    },
    {
        ...
        url: `${server[3]}/listen/Bin Bulaye - Dino James`,
        Duration: "4: 37",
        Artist: "Dino James",
        Type: "Single",
        releaseDate: date("24-11-2021")
        ...
        Tracks: [
            {
                ...
                url: `${server[3]}/listen/Chikni Chameli - Agneepath`,
                Duration: "5: 03"
            },
            {
                ...
                url: `${server[3]}/listen/Abhi Mujh Mein Kahin - Agneepath`,
                Duration: "6: 04"
            }
        ]
    },
    {
        ...
        url: `${server[3]}/listen/Goat Dekho - Raftaar`,
        Duration: "3: 33",
        Artist: "Raftaar",
        Type: "Single",
        releaseDate: date("30-11-2021")
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "4: 29",
                url: `${server[3]}/listen/Chaka Chak - Atrangi Re`
            },
            {
                ...
                Duration: "4: 51",
                url: `${server[3]}/listen/Rait Zara Si - Atrangi Re`
            }
        ]
    },
    {
        ...
        url: `${server[3]}/listen/Slow Slow - Badshah`,
        Duration: "3: 40",
        Artist: "Badshah, Payal Dev",
        Type: "Single",
        releaseDate: date("07-12-2021")
    },
    {
        ...
        url: `${server[3]}/listen/Bijlee Bijlee - Harrdy Sandhu`,
        Duration: "2: 48",
        Artist: "Harrdy Sandhu",
        Type: "Single",
        releaseDate: date("30-10-2021")
    },
    {
        ...
        url: `${server[3]}/listen/Dance Meri Rani - Guru Randhawa`,
        Duration: "3: 43",
        Artist: "Tanishk Bagchi, Guru Randhawa, Zahrah S Khan",
        Type: "Single",
        releaseDate: date("21-12-2021")
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Pritam, Arijit Singh",
                Duration: "3: 37",
                url: `${server[3]}/listen/Lehra Do - 83`
            },
            {
                ...
                Artist: "Pritam, Arijit Singh",
                Duration: "3: 57",
                url: `${server[3]}/listen/Jeetega Jeetega Film Version - 83`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 47",
                url: `${server[3]}/listen/Mehram - Jersey`
            },
            {
                ...
                Artist: "Sachet Tandon",
                Duration: "3: 51",
                url: `${server[3]}/listen/Maiyya Mainu - Jersey`
            },
            {
                ...
                Duration: "3: 07",
                url: `${server[3]}/listen/Baliye Re - Jersey`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 55",
                url: `${server[3]}/listen/Endo Bareda - GGVV`
            },
            {
                ...
                Duration: "2: 47",
                url: `${server[3]}/listen/Sojugada Soojumallige - GGVV`
            }
        ]
    },
    {
        ...
        url: `${server[3]}/listen/Excuses - AP Dhillon`,
        Duration: "2: 56",
    ...
    },
    {
        ...
        url: `${server[3]}/listen/Saada Pyaar - AP Dhillon`,
        Duration: "3: 33",
        Artist: "AP Dhillon, Gurinder Gill, Money Musik",
        Type: "Single",
        releaseDate: date("19-12-2021")
    },
    {
        ...
        Tracks: [
            {
                ...
                lyrics: true,
                sync: true,
                url: `${server[3]}/listen/IICONIC - King`
            },
            {
                ...
                lyrics: true,
                sync: true,
                url: `${server[3]}/listen/Tu Aake Dekhle - King`
            }
        ]
    },
    {
    ...
    },
    {
        ...
        url: `${server[3]}/listen/Arabic Kuthu - Beast`,
        Duration: "4: 39",
    ...
    },
    {
        ...
        url: `${server[3]}/listen/Afsanay - Young Stunners`,
        Duration: "5: 43",
        lyrics: true,
        sync: true,
    ...
    },
    {
        ...
        Duration: "4: 07",
        url: `${server[3]}/listen/Ilzaam - Arjun Kanungo`
    },
    {
        ...
        Duration: "3: 44",
        url: `${server[3]}/listen/Pasoori - CokeStudio14`
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 33",
                url: `${server[3]}/listen/Toofan - KGF Chapter 2 (Kannada)`
            },
            {
                ...
                Duration: "2: 51",
                url: `${server[3]}/listen/Gagana Nee - KGF Chapter 2 (Kannada)`
            },
            {
                ...
                Duration: "3: 45",
                url: `${server[3]}/listen/Sulthana - KGF Chapter 2 (Kannada)`
            },
            {
    ...
    },
    {
        ...
        Artist: "KR$NA",
        Duration: "3: 12",
        url: `${server[3]}/listen/Lil Bunty - KR$NA`
    },
    {
    ...
    },
    {
        ...
        Duration: "3: 51",
        url: `${server[2]}/listen/Chedkhaniyan - Shehzada`
    },
    {
        ...
        Tracks: [
            {
                ...
                Duration: "3: 49",
                url: `${server[3]}/listen/All Night (Live) - AP Dhillon`
            },
            {
                ...
                Artist: "AP Dhillon",
                Duration: "2: 57",
                url: `${server[3]}/listen/Summer High - AP Dhillon`
            },
            {
                ...
                Artist: "AP Dhillon, Shinda Kahlon",
                Duration: "3: 53",
                url: `${server[3]}/listen/Dil Nu - AP Dhillon`
            }
        ]
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Pritam, Arijit Singh, Nikhita Gandhi",
                Duration: "4: 25",
                url: `${server[3]}/listen/Tere Pyaar Mein - Tu Jhoothi Main Makkaar`
            },
            {
                ...
                Artist: "Pritam, Arijit Singh",
                Duration: "3: 36",
                url: `${server[3]}/listen/Pyaar Hota Kayi Baar Hai - Tu Jhoothi Main Makkaar`
            },
            {
            ...
            },
            {
                ...
                Duration: "3: 42",
                url: `${server[3]}/listen/Jaadui - Tu Jhoothi Main Makkaar`,
                lyrics: true,
                sync: true
            }
        ]
    ...
    },
    {
        ...
        Artist: "Darshan Raval",
        Duration: "3: 01",
        url: `${server[3]}/listen/Mahiye Jinna Sohna - Darshan Raval`,
        lyrics: true,
        sync: true
    },
    {
    ...
    },
    {
        ...
        Artist: "Badshah, Payal Dev",
        Duration: "2: 47",
        url: `${server[3]}/listen/Gone Girl - Badshah`
    },
    {
        ...
        Tracks: [
            {
                ...
                Artist: "Arijit Singh",
                url: `${server[3]}/listen/Phir Na Aisi Raat Aayegi - Laal Singh Chaddha`,
                Duration: "4: 45",
                lyrics: true,
                sync: true
            },
            {
                ...
                url: `${server[3]}/listen/Tere Hawaale - Laal Singh Chaddha`,
                Duration: "5: 46",
                lyrics: true,
                sync: true
            },
            {
                ...
                url: `${server[3]}/hls/listen/Tere Hawale (Arijit - Shreya Duet) - Laal Singh Chaddha/output.m3u8`,
                Duration: "5: 48"
            }
        ]
    },
    ...
    },
    {
        ...
        Artist: "King, Natania",
        Duration: "3: 17",
        url: `${server[3]}/listen/CROWN - King`,
        lyrics: true,
        sync: true
    },
    {
        ...
        Tracks: [
            {
                ...
                url: `${server[3]}/hls/listen/Badass - Leo/output.m3u8`,
                Duration: "3: 49"
            },
            {
                ...
                Title: "Lokiverse 2.0",
                Artist: "Anirudh Ravichander",
                url: `${server[3]}/hls/listen/Lokiverse 2.0 - Leo/output.m3u8`,
                Duration: "1: 54"
            },
            {
                ...
                url: `${server[3]}/hls/listen/Ordinary Person - Leo/output.m3u8`,
                Duration: "2: 18"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                Title: "Ve Kamleya",
                Artist: "Arijit Singh, Shreya Ghoshal",
                url: `${server[3]}/hls/listen/Ve Kamleya - Rocky Aur Rani Kii Prem Kahaani/output.m3u8`,
                Duration: "4: 07"
            }
        ]
    },
        ...
        Tracks: [
            {
                ...
                Artist: "Arijit Singh",
                url: `${server[3]}/hls/listen/Lutt Putt Gaya - Dunki/output.m3u8`,
                Duration: "3: 43",
                lyrics: true,
                sync: true
            }
    ...
    },
    {
        ...
        Tracks: [
            ...
            },
            {
                ...
                url: `${server[3]}/hls/listen/Gallan - Teri Baaton Mein Aisa Uljha Jiya/output.m3u8`,
                Duration: "3: 31"
            }
        ]
    },
